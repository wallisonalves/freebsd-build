#
# Copyright (c) 2016, Eric Turgeon All rights reserved.
# Modified by: Wallison Alves <wallisonalvesdeoliveira@gmail.com>
#
...
#
# FreeBSD makefile. Main targets are:
#
